...
import type { ClientSettings, SettingListProps, SettingRangeProps, Settings, SettingsComponentValue } from '../../../utils/types'
                ...
                Object.entries(settings).map(([sectionName, sectionValue], i) => 
                    <div key={i}>
                        ...
                        <div className={styles.toggles}>
                            {
                                Object.entries(sectionValue).map(([key, {type, name, props, value}], j) => {
